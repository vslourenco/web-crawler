...
class QGAairsoftSpider(CrawlSpider):
    name = "qgairsoftSpider"
    ...
    def __init__(self, id_product, *a, **kw):
        super(QGAairsoftSpider, self).__init__(*a, **kw)
    ...
    def parse_item(self, response):
        ...
        airsoft["discount_price"] = response.xpath('(//div[contains(@class, "purchase-info")]/div/div[@class="price"]/small/b)[1]/text()').extract_first(default='99999')
